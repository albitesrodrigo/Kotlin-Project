...
@Composable
fun IcomesScreen(uiState: IncomesUiState, onIncomeClick: (income: Income) -> Unit) {
    ...
    LazyColumn(
        ...
        stickyHeader {
            Column(modifier = Modifier.background(colors.backgroundColor)) {
                // Composables
                IncomesTotalHeader(uiState.total)
                AllIncomesHeader()
            }
        }
        items(uiState.incomes) { income ->
            IncomesItem(income = income, onIncomeClick = onIncomeClick)
        }
    }
}

@Composable
fun IncomesTotalHeader(total: Double) {
    val colors = getColorsTheme()
    Card(
...
@Composable
fun IncomesItem(income: Income, onIncomeClick: (income: Income) -> Unit) {
    val colors = getColorsTheme()
